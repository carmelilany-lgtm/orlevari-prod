...
-- C. video_works
CREATE TABLE public.video_works (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX video_works_category_id_idx ON public.video_works(category_id);
CREATE INDEX video_works_published_sort_idx ON public.video_works(is_published, sort_order);

-- D. still_images
CREATE TABLE public.still_images (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX still_images_published_sort_idx ON public.still_images(is_published, sort_order);
...
-- ---------------------------------------------------------------------------
-- Data API grants (tables in public schema)
-- ---------------------------------------------------------------------------
